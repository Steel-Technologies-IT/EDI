 ...
 console.log("Creating O856 for pkey:", pkey);
  ...
  let CT = {
    ...
    let fiveRecord = {
      ...
      "ASN Date": await evaluatePriority(priority_1, priority_2, getValidDate(Header.hdr_bsn_dte), 'ASN Date', '05'),
      "ASN Time": await evaluatePriority(priority_1, priority_2, Header.hdr_bsn_tme.padStart(6, '0'), 'ASN Time', '05'),
      "Shipment Date": await evaluatePriority(priority_1, priority_2, getValidDate(Header.hdr_shp_dte), 'Shipment Date', '05'),
      "Shipment Time": await evaluatePriority(priority_1, priority_2, Header.hdr_shp_tme.padStart(6, '0'), 'Shipment Time', '05'),
...
for (const Detail40 of detail40s) {
  ...
  let thirtyRecord = {
   ...
   "New Cumulative Weight (KG)": null,//Needs to be defined
    ...
    "(I830-PS) Create Date": await evaluatePriority(priority_1, priority_2, _830 ? getValidDate(_830.dtl_crt_dte) : null, '(I830-PS) Create Date', '30'),
    "(I830-PS) Create Time": await evaluatePriority(priority_1, priority_2, _830 ? String(_830.dtl_crt_tme).padStart(6, '0').slice(0, 4) : null, '(I830-PS) Create Time', '30'),
    ...
    "(I862-SS) Create Date": await evaluatePriority(priority_1, priority_2, _862 ? getValidDate(_862.dtl_crt_dte) : null, '(I862-SS) Create Date', '30'),
    "(I862-SS) Create Time": await evaluatePriority(priority_1, priority_2, _862 ? String(_862.dtl_crt_tme).padStart(6, '0').slice(0, 4) : null, '(I862-SS) Create Time', '30'),
