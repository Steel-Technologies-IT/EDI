...
for (const Dtl of Detail) {
  ...
  console.log(`Calculating totals for Shop ${Dtl.dtl_invx_ref_no} and Part ${Dtl.dtl_cpart}`);
  console.log("Current Detail:", matchingMeasurements.find(m => m.msr_mea4 === '01' && m.msr_mea1 === 'WT')?.msr_mea3);
