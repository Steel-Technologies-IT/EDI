...
[
      ...
      null, //80 
      flag, //$81
      Item.shp_enduserreference1,
      Item.shp_enduserreference2,
      Item.shp_enduserreference3,
      Item.shp_enduserreference4,
      Item.shp_enduserreference5,
      Item.shp_partrevisionnumber,
      Item.shp_invexreferenceprefix,
      Item.shp_invexreferencenumber,
      Item.shp_taglotid,
      Item.shp_partnumber
])
