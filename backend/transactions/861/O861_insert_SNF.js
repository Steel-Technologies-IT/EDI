...
[
      ...
      ProductItem.prd_externalorderitem ? ProductItem.prd_externalorderitem : orginalDetail ? ( orginalDetail.rows[0].dtl_pol && orginalDetail.rows[0].dtl_pol !== '000' ? orginalDetail.rows[0].dtl_pol : orginalDetail.rows[0].dtl_mol && orginalDetail.rows[0].dtl_mol !== '000'? orginalDetail.rows[0].dtl_mol : null ) : null, //26 dtl_pol
      ...
      ['ED', 'E8', 'EM', 'E7', 'IN'].includes(ProductItem.prd_x12gaugeum) ? ProductItem.prd_gaugesize : ['MM', 'MB', 'M2', 'MZ', 'MY'].includes(ProductItem.prd_x12widthum) ? ProductItem.prd_gaugesize / 25.4 : orginalDetail ? orginalDetail.rows[0].dtl_gaugin : null, //38 dtl_gaugin
      ['MM', 'MB', 'M2', 'MZ', 'MY'].includes(ProductItem.prd_x12gaugeum) ? ProductItem.prd_gaugesize : ['ED', 'E8', 'EM', 'E7', 'IN'].includes(ProductItem.prd_x12widthum) ? ProductItem.prd_gaugesize * 25.4 : orginalDetail ? orginalDetail.rows[0].dtl_gaugmm : null, //39 dtl_gaugmm  
      ...
      ['FT', 'LF'].includes(ProductItem.prd_x12coillengthum) ? ProductItem.prd_coillength : ['MT', 'MR'].includes(ProductItem.prd_x12coillengthum) ? ProductItem.prd_coillength * 3.28084 : orginalDetail ? orginalDetail.rows[0].dtl_lnft : null, //45 dtl_lnft
      ['MT', 'MR'].includes(ProductItem.prd_x12coillengthum) ? ProductItem.prd_coillength : ['FT', 'LF'].includes(ProductItem.prd_x12coillengthum) ? ProductItem.prd_coillength / 3.28084 : orginalDetail ? orginalDetail.rows[0].dtl_lnmt : null, //46 dtl_lnmt 
