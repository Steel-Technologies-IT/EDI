...
for (const TagLots of uniqueLines) {
  ...
  const countliftid =  liftIdCountsByKey?.[pkey]?.[Detail30.dtl_liftid] || 0;
      ...
      "STTX Tag": countliftid > 1 ? Detail30.dtl_tag_lot : (String(Detail30.dtl_liftid ?? '').trim() !== '' ? Detail30.dtl_liftid : Detail30.dtl_tag_lot),// Detail30.dtl_tag_lot, // written by AS/400 from TCCHMDP1 . TCDSERN
      "STTX Alternate Tag": String(Detail30.dtl_liftid ?? '').trim() !== '' ? Detail30.dtl_liftid : Detail30.dtl_tag_lot, // written by AS/400 from TCF100RG.P#1RETN	EIO863P2.OTTAG	Serial build coming from TCF100RG
