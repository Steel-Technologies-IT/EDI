...
async function get870InterchangeControl(pool, keyPK) {
    ...
    try {
        ...
        const results = await pool.query(`SELECT ictl_companyid,ictl_senderinterchangeidqualifier,ictl_senderinterchangeid,ictl_edixcontrolnumber,ictl_receiverinterchangeidqualifier,ictl_receiverinterchangeid,ictl_createddatetime,ictl_alternateinterchangenumber,ictl_status
...
async function get870HeaderNameAddress(pool, keyPK) {
    ...
    try {
        ...
        const results = await pool.query(`SELECT DISTINCT
            hdna_itemnumber,hdna_edixaddresstype,hdna_identificationcodequalifier,hdna_identificationcode,hdna_name1,hdna_name2,hdna_address1,hdna_address2,hdna_address3,hdna_city,hdna_postalcode,hdna_countrycode,hdna_stateprovincecode,hdna_telephoneareacode,hdna_telephonenumber,hdna_telephoneextension,hdna_faxareacode,hdna_faxnumber,hdna_faxextension
...
async function get870ProductItemInstructions(pool, keyPK) {
    ...
    try {
        ...
        const results = await pool.query(`SELECT prii_invexinstructiontype, prii_text
...
async function get870NonRecordedScrapItems(pool, keyPK) {
    ...
    try {
        ...
        const results = await pool.query(`SELECT 
            nrscr_scrapdamagecode,nrscr_pieces,nrscr_measurelength,nrscr_x12measurelengthum,nrscr_opsmeasurelengthum,nrscr_measurearea,nrscr_x12measureareaum,nrscr_opsmeasureareaum,nrscr_weight,nrscr_x12weightum,nrscr_opsweightum,nrscr_itemnumber
...
async function get870ProductItemNameAddress(pool, keyPK) {
    ...
    try {
        ...
        const results = await pool.query(`SELECT 
            prna_itemnumber, prna_edixaddresstype, prna_identificationcodequalifier, prna_identificationcode, prna_name1, prna_name2, prna_address1, prna_address2, prna_address3, prna_city, prna_postalcode, prna_countrycode, prna_stateprovincecode, prna_telephoneareacode, prna_telephonenumber, prna_telephoneextension, prna_faxareacode, prna_faxnumber, prna_faxextension
