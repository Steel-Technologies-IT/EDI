...
async function get870InterchangeControl(pool, keyPK, filePath) {
    var structuredRes = {};
    try {
...
//870 TransactionSet
async function get870TransactionSet(pool, keyPK, filePath) {
    var structuredRes = {};
    try {
...
async function get870ProductionReportingHeader(pool, keyPK, filePath) {
    var structuredRes = {};
    try {
...
async function get870HeaderInstructions(pool, keyPK, filePath) {
    var structuredRes = {};
    try {
        ...
        const results = await pool.query(`SELECT
            ...
            WHERE hdin_key = $1`, [parseInt(keyPK)]);
        structuredRes = results.rows;
...
//870 Header Instructions
async function get870NonRecordedScrapItems(pool, keyPK, filePath) {
    var structuredRes = {};
    try {
...
//870 Damages
async function get870Damages(pool, keyPK,   filePath) {
    var structuredRes = {};
    try {
...
async function get870ProductItemInstructions(pool, keyPK , filePath) {
    var structuredRes = {};
    try {
...
async function get870ProductItemNameAddress(pool, keyPK , filePath) {
    var structuredRes = {};
    try {
...
async function get870TransactionErrors(pool, keyPK, filePath) {
    var structuredRes = {};
    try {
